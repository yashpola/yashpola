const MoviePosts = {
  ...
  Goodfellas: {
    ...
    thoughts: `Why I felt Goodfellas is a better version of WOWS: 
    Firstly, I'm a sucker for performances and the ensemble of De Niro, Pesci and Liotta felt a whole lot more enthralling to me than Wolf which I felt was essentially the Leo show (a pity Liotta's not worked with Scorsese again since then). Whether it's Pesci nailing the vibe of an actual lunatic (along with being a really funny guy), De Niro effortlessly delivering the ever-so-insecure and hungry-for-control mobster, or Liotta taking us through his character's mental and physical breakdown as his actions catch up with him, there's always something bold and satisfying to witness. 
